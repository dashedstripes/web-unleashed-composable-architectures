...
const functions = {}; const metadata = { functions: {} };
      ...
      try {
        const { default: func } = await import("file:///Users/adamgray/Code/web-unleashed-composable-architectures/.netlify/edge-functions/next-dev/index.js");

        if (typeof func === "function") {
          functions["next-dev"] = func;
          metadata.functions["next-dev"] = {"url":"file:///Users/adamgray/Code/web-unleashed-composable-architectures/.netlify/edge-functions/next-dev/index.js"}
        } else {
